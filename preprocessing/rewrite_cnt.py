...
for item in data:
	...
	# resultUser_Follwer.append(userData[userId]['followers_count'])
	# resultUser_Statues.append(userData[userId]['statuses_count'])
...
idCountDict = {}
for item in range(len(resultUser)):
